...
The free tool that I recommend to scan objects for use with Sketchfab is called Kiri Engine. This is a very simple to use app that lets you do basic photogrammetry completely for free. More importantly, it produces a nice zipped folder with an object file and texture, allowing for the easiest experience uploading your model.

You can find Kiri Engine online at www.kiriengine.app or on your phones app store.
...
Simply walk around the object while your phone photographs it, trying to do one round with a low angle on the object, one straight on, and on from a high angle to get full coverage of the object.

Once you have 75 to 100 photos, end the session and make sure to have the app create an .obj file (this should be default).

![Photo of a dinosaur toy](photo-example.jpg)

## Hosting your object
First you will need to download the files from Kiri Engines Web App. Once you have the .zip folder for your object you are ready to upload it to a model hosting site.

I recommend hosting your models using Sketchfab as it is free and has an embeddable object viewer.

You will need to make an account at www.sketchfab.com and then login.
